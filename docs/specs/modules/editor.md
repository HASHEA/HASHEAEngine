...
- Terrain authoring 还需运行 focused stroke/layer command、幂等历史门禁、稳定选择、锁定与 rollback/quarantine 契约，以及 Debug/Release 全量 `RunTests.bat`。

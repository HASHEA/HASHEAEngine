...
Approved（2026-07-16；用户批准 contract-first 方案，并授权后续阶段采用明确标注的推荐方案时无需重复等待；Task 2 codec 执行澄清于同日按该持续授权并入；2026-07-26 用户批准 Task 9 bake surface binding 修订为按次显式传入）

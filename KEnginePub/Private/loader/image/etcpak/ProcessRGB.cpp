...
namespace
{
    ...
    {
        int i = (std::min<int>(std::max<int>(static_cast<int>(f), 0), 1023) - 15) >> 1;
...
static etcpak_force_inline uint64_t ProcessAlpha_ETC2(const uint8_t* src)
{
    ...
    uint16_t sm = (uint16_t)_mm_cvtsi128_si64(srcMid);
...
#undef EAC_RECONSTRUCT_VALUE
    ...
    uint8_t buf[16][16];
    int     err = 2147483647; // INT_MAX or std::numeric_limits<int>::max();
    int     sel;
    int     selmul;
    for (int r = 0; r < 16; r++)
    {
...
void ETC_PAK::CompressEtc1Alpha(const uint32_t* src, uint64_t* dst, uint32_t blocks, size_t width)
{
    int      w = 0;
    uint32_t buf[4 * 4];
    do
...
void ETC_PAK::CompressEtc2Alpha(const uint32_t* src, uint64_t* dst, uint32_t blocks, size_t width)
{
    int      w = 0;
    uint32_t buf[4 * 4];
    do
...
void ETC_PAK::CompressEtc1Rgb(const uint32_t* src, uint64_t* dst, uint32_t blocks, size_t width)
{
    int      w = 0;
    uint32_t buf[4 * 4];
    do
...
void ETC_PAK::CompressEtc1RgbDither(const uint32_t* src, uint64_t* dst, uint32_t blocks, size_t width)
{
    int      w = 0;
    uint32_t buf[4 * 4];
    do
...
void ETC_PAK::CompressEtc2Rgb(const uint32_t* src, uint64_t* dst, uint32_t blocks, size_t width)
{
    int      w = 0;
    uint32_t buf[4 * 4];
    do
...
void ETC_PAK::CompressEtc2Rgba(const uint32_t* src, uint64_t* dst, uint32_t blocks, size_t width)
{
    int      w = 0;
    uint32_t rgba[4 * 4];
    uint8_t  alpha[4 * 4];

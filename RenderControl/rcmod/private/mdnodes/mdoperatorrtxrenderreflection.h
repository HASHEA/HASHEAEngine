/*
    filename:       mdoperatorrtxrenderreflection.h
    author:         Yang Bin
    date:           2020-Apr-15
    description:
*/
...
class MDOperatorRTXRenderReflection : public MDOperatorCpu
{
public:
    MDOperatorRTXRenderReflection();
    virtual ~MDOperatorRTXRenderReflection();

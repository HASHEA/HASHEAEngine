/*
filename:       mdoperatordefaultvxgiwithouttrp.h
author:         Bin Yang
date:           2018-Jul-4
description:
*/
...
class MDOperatorDefaultVXGIWithoutTRP : public MDOperatorCpu
{
public:
	MDOperatorDefaultVXGIWithoutTRP();
	virtual ~MDOperatorDefaultVXGIWithoutTRP();

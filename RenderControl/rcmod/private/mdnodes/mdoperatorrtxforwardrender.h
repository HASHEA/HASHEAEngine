/*
filename:       mdoperatorrtxforwardrender.h
author:         Bin Yang
date:           2019-Jun-4
description:
*/
...
class MDOperatorRTXForwardRender : public MDOperatorCpu
{
public:
	MDOperatorRTXForwardRender();
	virtual ~MDOperatorRTXForwardRender();

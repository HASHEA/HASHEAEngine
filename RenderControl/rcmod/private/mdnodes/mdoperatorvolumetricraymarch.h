/*
filename:       mdoperatorvolumetricraymarch.h
author:         Wenze Dong
date:
description:
*/
...
class MDOperatorVolumetricRayMarch : public MDOperatorCpu
{
public:
    MDOperatorVolumetricRayMarch();
    virtual ~MDOperatorVolumetricRayMarch();

/*
filename:       mdoperatorrenderwaterpreparationrtx.h
author:         Ming Dong
date:           2019-JUL-31
description:
*/
...
class MDOperatorRenderWaterPreparationRTX : public MDOperatorCpu
{
public:
    MDOperatorRenderWaterPreparationRTX();
	virtual ~MDOperatorRenderWaterPreparationRTX();

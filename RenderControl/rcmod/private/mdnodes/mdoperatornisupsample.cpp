...
#include"mdoperatornisupsample.h"
...
MDOperatorNISUpsample::MDOperatorNISUpsample()
    :m_OperatorName("MDNIS")
{
}
...
const DString& MDOperatorNISUpsample::getOperatorName()const
{
    return m_OperatorName;
}

Bool MDOperatorNISUpsample::isGpuOperator()const
{
    return DM_FALSE;
}

Int MDOperatorNISUpsample::getInputCount()const
{
    return s_InputCount;
}

Int MDOperatorNISUpsample::getOutputCount()const
{
    return 1;
}

DSimpleTypeID MDOperatorNISUpsample::getInputTypeID(Int i_Index)const
{
...
DSimpleTypeID MDOperatorNISUpsample::getOutputTypeID(Int i_Index, MDEffect* i_pMDEffect, Int i_ParamCount, const MDOperandCPtr* i_pParamList)const
{
    return RCGlobal::k_SimpleTypeID_OSTexture2D;
}

RCGPUDATAFORMAT MDOperatorNISUpsample::getOutputTexFmt(Int i_Index, MDEffect* i_pMDEffect, Int i_ParamCount, const MDOperandCPtr* i_pParamList)const
{
    return RGDF_RGBA8;
}

DResult MDOperatorNISUpsample::calcOutputTexSize(Int i_Index, MDEffect* i_pMDEffect, DVector2i& o_Size, Int i_ParamCount, const MDOperandCPtr* i_pParamList)const
{
...
MDOperandPtr MDOperatorNISUpsample::execute(MDEffect* i_pMDEffect, Int i_ParamCount, const MDOperandPtr* i_pParamList, IRP* o_pInputReleasePoint)const
{
    ...
    float l_Sharpness;
    l_Sharpness = l_pQualityValue->getF32();
    ...
    *((OSTexture2D*)l_InputTexture.getPtr()) = l_pTextureValue->getValue<OSTexture2D>();
    ...
    l_pScenePlugin->RenderNISUpsample((RCOSRendererData*)l_pRenderer->getOSRendererData(), &l_UpsampleTexture, &l_InputTexture, l_Sharpness);
...
DResult  MDOperatorNISUpsample::destroyResult(MDEffect* i_pMDEffect, Int i_ParamCount, const MDOperandPtr* i_pParamList, MDOperandPtr i_pResult)const
{

/*
filename:       mdoperatorvolumecloudraymarch.h
author:         Wenze Dong
date:
description:
*/
...
class MDOperatorVolumeCloudRayMarch : public MDOperatorCpu
{
public:
    MDOperatorVolumeCloudRayMarch();
    virtual ~MDOperatorVolumeCloudRayMarch();

/*
filename:       mdoperatorscenerenderwaterssr.h
author:         Bin Yang
date:           2017-Oct-24
description:
*/
...
class MDOperatorSceneRenderWaterSSR : public MDOperatorCpu
{
public:
    MDOperatorSceneRenderWaterSSR();
	virtual ~MDOperatorSceneRenderWaterSSR();

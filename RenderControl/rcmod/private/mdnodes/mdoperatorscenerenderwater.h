/*
filename:       mdoperatorscenerenderwater.h
author:         Bin Yang
date:           2017-Oct-24
description:
*/
...
class MDOperatorSceneRenderWater : public MDOperatorCpu
{
public:
	MDOperatorSceneRenderWater();
	virtual ~MDOperatorSceneRenderWater();

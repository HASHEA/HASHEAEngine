/*
	filename:       mdoperatorrendergubffers.h
	author:         Li JianKnag
	date:           2021-12-17
	description:
*/
...
class MDOperatorRenderGBuffersForTerrainDecal : public MDOperatorCpu
{
public:
	MDOperatorRenderGBuffersForTerrainDecal();
	virtual ~MDOperatorRenderGBuffersForTerrainDecal();

/*
    filename:       mdoperatorscenerendertoforgrass.h
    author:         Ming Dong
    date:           2021-MAR-31
    description:    
*/
...
class MDOperatorSceneRenderToForGrass : public MDOperatorCpu
{
public:
    MDOperatorSceneRenderToForGrass();
    virtual ~MDOperatorSceneRenderToForGrass();

/*
    filename:       mdoperatordebugtexturebyrange.h
    author:         Mingrui Liu
    date:           2023-APR-18
    description:    
*/
...
class MDOperatorDebugTextureByRange : public MDOperatorCpu
{
public:
    MDOperatorDebugTextureByRange();
    virtual ~MDOperatorDebugTextureByRange();

/*
    filename:       mdoperatorrenderwaterpreto.h
    author:         Ming Dong
    date:           2016-Aug-24
    description:    
*/
...
class MDOperatorRenderWaterPreTo : public MDOperatorCpu
{
public:
    MDOperatorRenderWaterPreTo();
    virtual ~MDOperatorRenderWaterPreTo();

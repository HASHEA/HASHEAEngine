/*
    filename:       mdoperatorrtxrendergbuffers.h
    author:         Ming Dong
    date:           2017-Jun-27
    description:    
*/
...
class MDOperatorRTXRenderGBuffers : public MDOperatorCpu
{
public:
	MDOperatorRTXRenderGBuffers();
    virtual ~MDOperatorRTXRenderGBuffers();

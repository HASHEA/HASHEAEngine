/*
    filename:       mdoperatorclusterforwardoptions.h
    author:         Mingrui Liu
    date:           2023-FEB-10
    description:    
*/
...
class MDOperatorClusterForwardOptions : public MDOperatorCpu
{
public:
    MDOperatorClusterForwardOptions();
    virtual ~MDOperatorClusterForwardOptions();

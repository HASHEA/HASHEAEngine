/*
filename:       MDOperatorVolumeCloudShadowRayMarch.h
author:         Wenze Dong
date:
description:
*/
...
class MDOperatorVolumeCloudShadowRayMarch : public MDOperatorCpu
{
public:
    MDOperatorVolumeCloudShadowRayMarch();
    virtual ~MDOperatorVolumeCloudShadowRayMarch();

/*
    filename:       mdoperatorvolumetricheightfog.h
    author:         Huang Yida
    date:           2019-july-8
    description:    
*/
...
class MDOperatorVolumetricHeightFog : public MDOperatorCpu 
{
public:
    MDOperatorVolumetricHeightFog();
    virtual ~MDOperatorVolumetricHeightFog();

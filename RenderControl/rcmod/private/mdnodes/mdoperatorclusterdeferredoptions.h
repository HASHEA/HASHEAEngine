/*
    filename:       mdoperatorclusterdeferredoptions.h
    author:         Mingrui Liu
    date:           2023-FEB-10
    description:    
*/
...
class MDOperatorClusterDeferredOptions : public MDOperatorCpu
{
public:
    MDOperatorClusterDeferredOptions();
    virtual ~MDOperatorClusterDeferredOptions();

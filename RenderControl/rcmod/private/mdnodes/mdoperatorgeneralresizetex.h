/*
    filename:       mdoperatorgeneralresizetex.h
    author:         Ming Dong
    date:           2018-DEC-17
    description:    
*/
...
class MDOperatorGeneralResizeTex : public MDOperatorCpu
{
public:
    MDOperatorGeneralResizeTex();
    virtual ~MDOperatorGeneralResizeTex();

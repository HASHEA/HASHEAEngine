/*
filename:       mdoperatorrenderwaterpreparation.h
author:         Bin Yang
date:           2017-Oct-24
description:
*/
...
class MDOperatorRenderWaterPreparation : public MDOperatorCpu
{
public:
	MDOperatorRenderWaterPreparation();
	virtual ~MDOperatorRenderWaterPreparation();

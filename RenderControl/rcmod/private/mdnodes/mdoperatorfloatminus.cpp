...
#include "mdoperatorfloatminus.h"
...
MDOperatorFloatMinus::MDOperatorFloatMinus()
    : m_OperatorName("MDFloatMinus")
{
...
****************************/
const DString&      MDOperatorFloatMinus::getOperatorName() const
{
    return m_OperatorName;
}

Bool                MDOperatorFloatMinus::isGpuOperator() const
{
    return DM_FALSE;
}

Int                 MDOperatorFloatMinus::getInputCount() const
{
    return 1;
}

DSimpleTypeID       MDOperatorFloatMinus::getInputTypeID(Int i_Index) const
{
    return RCGlobal::k_SimpleTypeID_Unknown;
}

Int                 MDOperatorFloatMinus::getOutputCount() const
{
    return 1;
}

DSimpleTypeID       MDOperatorFloatMinus::getOutputTypeID(Int i_Index, MDEffect* i_pMDEffect, Int i_ParamCount, const MDOperandCPtr* i_pParamList) const
{
...
RCGPUDATAFORMAT     MDOperatorFloatMinus::getOutputTexFmt(Int i_Index, MDEffect* i_pMDEffect, Int i_ParamCount, const MDOperandCPtr* i_pParamList) const
{
    DOME_ASSERT(i_Index == 0);
    DOME_ASSERT(i_ParamCount == 1);
...
DResult             MDOperatorFloatMinus::calcOutputTexSize(Int i_Index, MDEffect* i_pMDEffect, DVector2i& o_Size, Int i_ParamCount, const MDOperandCPtr* i_pParamList) const
{
...
****************************/
MDOperandPtr        MDOperatorFloatMinus::execute(MDEffect* i_pMDEffect, Int i_ParamCount, const MDOperandPtr* i_pParamList, IRP* o_pInputReleasePoint) const
{
...
DResult             MDOperatorFloatMinus::destroyResult(MDEffect* i_pMDEffect, Int i_ParamCount, const MDOperandPtr* i_pParamList, MDOperandPtr i_pResult) const
{	
	DOME_Del(i_pResult);
	return R_SUCCESS;
}

/*
filename:       mdrendergbuffersforgrassandmodelfusion.h
author:         Wenze Dong
date:           2023 / 08 / 10
description:
*/
...
class MDOperatorRenderGBuffersForGrassAndModelFusion : public MDOperatorCpu
{
public:
    MDOperatorRenderGBuffersForGrassAndModelFusion();
    virtual ~MDOperatorRenderGBuffersForGrassAndModelFusion();

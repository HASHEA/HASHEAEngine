/*
    filename:       mdoperatoroutput_customize.h
    author:         Ming Dong
    date:           2021-May-07
    description:    
*/
...
class MDOperatorOutput_Customize : public MDOperatorCpu
{
public:
    MDOperatorOutput_Customize();
    virtual ~MDOperatorOutput_Customize();

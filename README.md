...
- Render Graph v1 正在以 Function/Render 层 orchestration 形式接入，当前已建立 graph texture handle、texture desc 与 graph access 到 RHI resource state 的基础映射，并由 `Sandbox --engine-self-test` 覆盖。

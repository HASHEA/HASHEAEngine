/*
filename:       mdoperatorscenerenderwaterrtx.h
author:         DONG MING
date:           2019-Aug-10
description:
*/
...
class MDOperatorSceneRenderWaterRTX : public MDOperatorCpu
{
public:
    MDOperatorSceneRenderWaterRTX();
	virtual ~MDOperatorSceneRenderWaterRTX();

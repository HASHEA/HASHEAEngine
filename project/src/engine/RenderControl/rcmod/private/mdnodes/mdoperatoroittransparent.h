/*
    filename:       mdoperatorscenerender.hMDOperatorOITTransparent
    author:         Ming Dong
    date:           2016-Aug-24
    description:    
*/
...
class MDOperatorOITTransparent : public MDOperatorCpu
{
public:
    MDOperatorOITTransparent();
    virtual ~MDOperatorOITTransparent();

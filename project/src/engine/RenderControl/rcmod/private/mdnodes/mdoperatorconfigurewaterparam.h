/*
filename:       mdoperatorconfigurewaterparam.h
author:         Bin Yang
date:           2018-Nov-20
description:
*/
...
class MDOperatorConfigureWaterParam : public MDOperatorCpu
{
public:
	MDOperatorConfigureWaterParam();
	virtual ~MDOperatorConfigureWaterParam();

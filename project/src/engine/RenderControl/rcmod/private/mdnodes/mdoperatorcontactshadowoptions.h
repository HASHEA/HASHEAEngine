/*
    filename:       mdoperatorcontactshadowoptions.h
    author:         Mingrui Liu
    date:           2023-FEB-10
    description:    
*/
...
class MDOperatorContactShadowOptions : public MDOperatorCpu
{
public:
    MDOperatorContactShadowOptions();
    virtual ~MDOperatorContactShadowOptions();

/*
filename:       mdoperatorcompositeskyclouddaynight.h
author:         Wenze Dong
date:
description:
*/
...
class MDOperatorCompositeSkyCloudDayNight : public MDOperatorCpu
{
public:
    MDOperatorCompositeSkyCloudDayNight();
    virtual ~MDOperatorCompositeSkyCloudDayNight();

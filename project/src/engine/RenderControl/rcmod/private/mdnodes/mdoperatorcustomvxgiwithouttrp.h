/*
filename:       mdoperatorcustomvxgiwithouttrp.h
author:         Bin Yang
date:           2018-Oct-10
description:
*/
...
class MDOperatorCustomVXGIWithoutTRP : public MDOperatorCpu
{
public:
	MDOperatorCustomVXGIWithoutTRP();
	virtual ~MDOperatorCustomVXGIWithoutTRP();

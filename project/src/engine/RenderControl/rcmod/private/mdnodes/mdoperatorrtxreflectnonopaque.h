/*
filename:       mdoperatorrtxreflectnonopaque.h
author:         Bin Yang
date:           2019-Jun-20
description:
*/
...
class MDOperatorRTXReflectNonOpaque : public MDOperatorCpu
{
public:
	MDOperatorRTXReflectNonOpaque();
	virtual ~MDOperatorRTXReflectNonOpaque();

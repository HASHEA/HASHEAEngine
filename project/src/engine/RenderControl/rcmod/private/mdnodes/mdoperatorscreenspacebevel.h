/*
	filename:       mdoperatorscreenspacebevel.h
	author:         Wenze Dong
	date:           2023-08-04
	description:
*/
...
class MDOperatorScreenSpaceBevel :public MDOperatorCpu
{
public:
	MDOperatorScreenSpaceBevel();
	virtual ~MDOperatorScreenSpaceBevel();

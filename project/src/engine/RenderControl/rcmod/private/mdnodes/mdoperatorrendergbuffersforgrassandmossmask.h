/*
filename:       mdoperatorrendergbuffersforgrassandambientocclusion.h
author:         Wenze Dong
date:           2023 / 09 / 25
description:
*/
...
class MDOperatorRenderGBuffersForGrassAndMossMask : public MDOperatorCpu
{
public:
    MDOperatorRenderGBuffersForGrassAndMossMask();
    virtual ~MDOperatorRenderGBuffersForGrassAndMossMask();

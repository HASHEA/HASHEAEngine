/*
filename:       mdoperatorgivoxelizationdebug.h
author:         Bin Yang
date:           2018-Aug-14
description:
*/
...
class MDOperatorGIVoxelizationDebug : public MDOperatorCpu
{
public:
	MDOperatorGIVoxelizationDebug();
	virtual ~MDOperatorGIVoxelizationDebug();

...
namespace AshEngine
{
	...
	// Relies on the trusted TerrainWorkingSet invariant. Publication shallow-validates
	// source metadata/shapes and deep-validates dirty payloads; it does not rescan all
	// historical source scalar arrays.

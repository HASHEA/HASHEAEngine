...
float4 PSMain(VSOutput input) : SV_Target0
{
    ...
    float3 backgroundA = float3(0.033, 0.050, 0.090);
    float3 backgroundB = float3(0.020, 0.110, 0.120);
    ...
    float3 logoColor = float3(0.070, 0.910, 0.780);
    float3 highlightColor = float3(0.760, 1.000, 0.960);

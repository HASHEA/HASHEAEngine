...
namespace ImGui {
    ...
    // Only provide the shim when the hosting ImGui build stripped the obsolete key IO API.
    // AshEngine's bundled ImGui keeps ImGui::GetKeyIndex, so defining it here would collide at link time.
